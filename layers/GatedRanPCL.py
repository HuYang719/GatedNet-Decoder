...
from layers import RanPCLMatrix
...
class GatedRanPCL(Layer):
    ...
    def __init__(self, units,
        ...
        super(GatedRanPCL, self).__init__(**kwargs)
        self.units = units
        ...
        self.mask =RanPCLMatrix.matrix128_256
    ...
    def get_config(self):
        ...
        base_config = super(GatedRanPCL, self).get_config()
